...
$settings = get_option(
	...
	array(
		...
		'badge_size'                         => 'medium',
		'badge_text'                         => __( 'Eco-Friendly Site', 'greenmetrics' ),
		...
		'popover_title'                      => __( 'Environmental Impact', 'greenmetrics' ),
